...
impl PresetLibrary {
    ...
    pub(crate) fn load_bass_presets(&mut self) {
        ...
        variations.insert("bright".to_string(), PresetVariation {
        ...
        variations.insert("dark".to_string(), PresetVariation {
            name: "Dark".to_string(),
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            description: "Classic warm Moog bass with ladder filter resonance and characteristic punch".to_string(),
            inspiration: "Moog Minimoog Model D".to_string(),
            tags: vec!["vintage".to_string(), "warm".to_string(), "funk".to_string(), "rock".to_string(), "analog".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(800.0, 0.6, FilterType::LowPass)),
        ...
        tb303_variations.insert("squelchy".to_string(), PresetVariation {
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            category: PresetCategory::Bass,
            subcategory: "Analog".to_string(),
            description: "Squelchy, resonant acid bass with characteristic slides and accents".to_string(),
            inspiration: "Roland TB-303 Bassline".to_string(),
            tags: vec!["acid".to_string(), "house".to_string(), "electronic".to_string(), "squelchy".to_string(), "resonant".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(700.0, 0.8, FilterType::LowPass)),
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["sharp".to_string(), "aggressive".to_string(), "bite".to_string(), "vintage".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Sawtooth,
                frequency: 110.0,
                amplitude: 0.85,
                ...
                filter: Some(PresetLibrary::create_filter(900.0, 0.7, FilterType::LowPass)),
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["rich".to_string(), "warm".to_string(), "lush".to_string(), "analog".to_string(), "vintage".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Sawtooth,
                frequency: 110.0,
                amplitude: 0.8,
                ...
                filter: Some(PresetLibrary::create_filter(750.0, 0.5, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_chorus(0.3), PresetLibrary::create_reverb(0.2)],
            },
            variations: HashMap::new(),
        });
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            description: "Clean digital FM bass with punchy attack, famous in hip-hop and house".to_string(),
            inspiration: "Yamaha TX81Z 'Lately Bass'".to_string(),
            tags: vec!["digital".to_string(), "fm".to_string(), "clean".to_string(), "punchy".to_string(), "hip-hop".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(1000.0, 0.3, FilterType::LowPass)),
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["percussive".to_string(), "fm".to_string(), "sharp".to_string(), "metallic".to_string(), "80s".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::FM { 
                ...
                filter: Some(PresetLibrary::create_filter(1200.0, 0.4, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_reverb(0.08)],
            },
            variations: HashMap::new(),
        });
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["sawtooth".to_string(), "classic".to_string(), "modern".to_string(), "clean".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Sawtooth,
                frequency: 110.0,
                amplitude: 0.8,
                ...
                filter: Some(PresetLibrary::create_filter(850.0, 0.5, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_reverb(0.15)],
            },
            variations: HashMap::new(),
        });
        ...
        square_variations.insert("narrow".to_string(), PresetVariation {
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            inspiration: "Modern Digital Synthesizers".to_string(),
            tags: vec!["square".to_string(), "pulse".to_string(), "digital".to_string(), "clean".to_string()],
            synth_params: SynthParams {
                ...
                duration: 1.0,
                envelope: PresetLibrary::create_envelope(0.01, 0.3, 0.7, 0.5),
                filter: Some(PresetLibrary::create_filter(900.0, 0.4, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_reverb(0.12)],
            },
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["sub".to_string(), "deep".to_string(), "fundamental".to_string(), "electronic".to_string(), "foundation".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(120.0, 0.2, FilterType::LowPass)),
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["elastic".to_string(), "bouncy".to_string(), "creative".to_string(), "character".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Sawtooth,
                frequency: 110.0,
                amplitude: 0.8,
                ...
                filter: Some(PresetLibrary::create_filter(600.0, 0.7, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_chorus(0.4), PresetLibrary::create_reverb(0.18)],
            },
            variations: HashMap::new(),
        });
    }
