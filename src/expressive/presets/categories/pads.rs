...
impl PresetLibrary {
    ...
    pub(crate) fn load_pad_presets(&mut self) {
        ...
        jp8_variations.insert("lush".to_string(), PresetVariation {
            name: "Lush".to_string(),
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            description: "Classic Jupiter-8 string ensemble with rich, warm analog character".to_string(),
            inspiration: "Roland Jupiter-8".to_string(),
            tags: vec!["strings".to_string(), "warm".to_string(), "analog".to_string(), "lush".to_string(), "vintage".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(1200.0, 0.3, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_chorus(0.5), PresetLibrary::create_reverb(0.4)],
            },
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["brass".to_string(), "creamy".to_string(), "analog".to_string(), "oberheim".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Sawtooth,
                frequency: 440.0,
                amplitude: 0.7,
                ...
                filter: Some(PresetLibrary::create_filter(1000.0, 0.4, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_chorus(0.3), PresetLibrary::create_reverb(0.3)],
            },
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["atmospheric".to_string(), "flowing".to_string(), "texture".to_string(), "analog".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(900.0, 0.3, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_chorus(0.4), PresetLibrary::create_reverb(0.6)],
            },
            variations: HashMap::new(),
        });
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            description: "Famous Roland D-50 preset with complex attack samples and analog synthesis".to_string(),
            inspiration: "Roland D-50 'Fantasia'".to_string(),
            tags: vec!["d-50".to_string(), "famous".to_string(), "complex".to_string(), "digital".to_string(), "cinematic".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Pad { 
                    warmth: 0.6, 
                    movement: 0.8, 
                ...
                filter: Some(PresetLibrary::create_filter(1500.0, 0.2, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_chorus(0.6), PresetLibrary::create_reverb(0.7)],
            },
            variations: HashMap::new(),
        });
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["crystal".to_string(), "bright".to_string(), "clean".to_string(), "digital".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(2000.0, 0.1, FilterType::LowPass)), // Bright filter
                effects: vec![PresetLibrary::create_chorus(0.3), PresetLibrary::create_reverb(0.5)],
            },
            variations: HashMap::new(),
        });
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["space".to_string(), "cosmic".to_string(), "atmospheric".to_string(), "ethereal".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Pad { 
                    warmth: 0.4, 
                    movement: 0.9, 
                ...
                filter: Some(PresetLibrary::create_filter(800.0, 0.2, FilterType::LowPass)),
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["dark".to_string(), "mysterious".to_string(), "suspense".to_string(), "moody".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Sawtooth,
                ...
                filter: Some(PresetLibrary::create_filter(400.0, 0.5, FilterType::LowPass)), // Dark filter
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            category: PresetCategory::Pad,
            subcategory: "Atmospheric".to_string(),
            description: "Vocal-like pad simulating choir atmosphere with warm harmonics".to_string(),
            inspiration: "Orchestral Synthesizer Traditions".to_string(),
            tags: vec!["choir".to_string(), "vocal".to_string(), "warm".to_string(), "harmonics".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(1100.0, 0.3, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_chorus(0.5), PresetLibrary::create_reverb(0.7)], // Choir-like effects
            },
            variations: HashMap::new(),
        });
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["wind".to_string(), "breathy".to_string(), "organic".to_string(), "movement".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::Noise { color: crate::expressive::NoiseColor::White },
                frequency: 440.0,
                amplitude: 0.4, // Softer for wind character
                duration: 12.0, // Very long for ambience
                envelope: PresetLibrary::create_envelope(3.0, 2.0, 0.6, 4.0), // Very slow development
                filter: Some(PresetLibrary::create_filter(600.0, 0.1, FilterType::BandPass)), // Shaped noise
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            category: PresetCategory::Pad,
            subcategory: "Atmospheric".to_string(),
            description: "Surreal, dream-like pad with floating, otherworldly character".to_string(),
            inspiration: "Ambient and New Age Music".to_string(),
            tags: vec!["dream".to_string(), "surreal".to_string(), "floating".to_string(), "otherworldly".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(1000.0, 0.2, FilterType::LowPass)),
                effects: vec![PresetLibrary::create_chorus(0.7), PresetLibrary::create_reverb(0.9)], // Maximum dreaminess
            },
            variations: HashMap::new(),
        });
    }
