...
impl PresetLibrary {
    ...
    pub(crate) fn load_effects_presets(&mut self) {
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["sci-fi".to_string(), "zap".to_string(), "energy".to_string(), "laser".to_string()],
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["sweep".to_string(), "rising".to_string(), "transition".to_string(), "build".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(1500.0, 0.2, crate::expressive::FilterType::LowPass)),
