...
impl PresetLibrary {
    ...
    pub(crate) fn load_drum_presets(&mut self) {
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["808".to_string(), "kick".to_string(), "hip-hop".to_string(), "deep".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(120.0, 0.2, crate::expressive::FilterType::LowPass)),
                effects: vec![],
            },
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["909".to_string(), "snare".to_string(), "techno".to_string(), "punchy".to_string()],
            synth_params: SynthParams {
                ...
                filter: Some(PresetLibrary::create_filter(2000.0, 0.3, crate::expressive::FilterType::HighPass)),
