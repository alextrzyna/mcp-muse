...
impl PresetLibrary {
    ...
    pub(crate) fn load_keys_presets(&mut self) {
        ...
        self.add_preset(ClassicSynthPreset {
            ...
            tags: vec!["dx7".to_string(), "electric".to_string(), "piano".to_string(), "fm".to_string()],
            synth_params: SynthParams {
                synth_type: SynthType::FM { modulator_freq: 880.0, modulation_index: 3.0 },
                frequency: 440.0,
                amplitude: 0.7,
                duration: 3.0,
                envelope: PresetLibrary::create_envelope(0.01, 0.8, 0.3, 1.2),
                filter: Some(PresetLibrary::create_filter(2000.0, 0.2, crate::expressive::FilterType::LowPass)),
